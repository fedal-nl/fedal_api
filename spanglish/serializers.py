...
class TranslationViewSerializer(serializers.ModelSerializer):
    word = serializers.SlugRelatedField(many=False, read_only=True, slug_field="text")
    sentence = serializers.SlugRelatedField(many=False, read_only=True, slug_field="text")
